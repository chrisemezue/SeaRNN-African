...
# Test these models
python main_seq2seq.py --dataset nmt --dataroot ${DATA_ROOT}/iwlst14_${src}-${tgt}_train_test.train.pt --revert_input_sequence --memory_size 256 --memory_size_encoder 256 --rnn_depth 1 --bidirectional --attention --attn_type sum-tanh --max_iter 0 --print_iter 1 --eval_iter 100 --save_iter 100 --eval_size 1500 --checkpoint_file /home/mila/c/chris.emezue/scratch/searnn-output/${src}-${tgt}${append}/checkpoint_iter_25000.pth
